...
class botoeira:
    ...
    def await_button(self):
        ...
        if not self.flagPararTempo:
            ...
            self.log_manager.gera_log("Iniciando botoeira_global_planner_linear_dinamica_demo_node: " + str(self.tempo_atual) + " segundos.", LogManager.Info)
...
if __name__ == "__main__":
    rospy.init_node("botoeira_global_planner_linear_dinamica_demo_node", anonymous=True)
    objt = botoeira()
    rate = rospy.Rate(5)
