...
rospy.init_node('service_execute_trajectory_client') # Initialise a ROS node with the name service_execute_trajectory_client
...
'''
use o comando: "rossrv show iri_wam_reproduce_trajectory/ExecTraj" para ver qual o Request e Response
da mensagem do serviço:
...
'''
Aqui está o código necessário para obter o caminho para os arquivos de trajetória
 com base no pacote onde eles estão. Aqui, o arquivo de trajetória "get_food.txt" é selecionado,
  mas você pode usar qualquer um dos disponíveis na pasta config do pacote "iri_wam_reproduce_trajectory".
'''
